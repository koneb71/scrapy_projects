...
# Scrapy settings for playmobil project
#
...
SPIDER_MODULES = ['playmobil.spiders']
NEWSPIDER_MODULE = 'playmobil.spiders'
...
ITEM_PIPELINES = {
    'playmobil.mysql_pipeline.MySQLStorePipeline': 300,
}
